...
export const Privacy = () => {
  return (
    <div style={styles.centre}>
      <br />
      <p>DealStryker, Inc. Privacy Policy</p>{" "}
      <p> Last Updated: April 7, 2020 </p> <br />
      <p>
        This Privacy Policy describes how your personal information is
        collected, used, and shared when you visit or make a purchase from
        https://www.dealstryker.com/ (the &ldquo;Site&rdquo;). This includes Car
      ...
      <p>
        ...
        <br />- &ldquo;Log files&rdquo; track actions occurring on the Site, and
        collect data including your IP address, browser type, Internet service
        provider, referring/exit pages, and date/time stamps.
        <br />- &ldquo;Web beacons,&rdquo; &ldquo;tags,&rdquo; and
      ...
      <p>
        ...
        <a href="mailto:contact@dealstryker.com ">contact@dealstryker.com</a>
      </p>
      <p>
        {" "}
